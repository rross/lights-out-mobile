const levelConfigs: Record<number, { moves: number; states: number }> = {};
...
const moves_32_50 = [
  15, 18, 20, 23, 25, 28, 30, 33, 35, 38, 40, 43, 45, 48, 50, 53, 55, 58, 60,
];
for (let i = 0; i < 19; i++) {
...
const moves_51_73 = [
  25, 28, 30, 33, 35, 38, 40, 43, 45, 48, 50, 53, 55, 58, 60, 63, 65, 68, 70,
  73, 75, 78, 80,
];
for (let i = 0; i < 23; i++) {
...
const moves_81_100 = [
  43, 45, 48, 50, 53, 55, 58, 60, 63, 65, 68, 70, 73, 75, 78, 80, 83, 85, 88,
  90,
];
for (let i = 0; i < 20; i++) {
...
const moves_106_127 = [
  38, 40, 43, 45, 48, 50, 53, 55, 58, 60, 63, 65, 68, 70, 73, 75, 78, 80, 83,
  85, 88, 90,
];
for (let i = 0; i < 22; i++) {
...
const moves_27_level_layer = [
  35, 38, 40, 43, 45, 48, 50, 53, 55, 58, 60, 63, 65, 68, 70, 73, 75, 78, 80,
